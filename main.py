...
# NOTE: For local testing, set your API key here or use environment variables.
# When pushing to GitHub, ensure this is set to a placeholder or handled securely.
...
if __name__ == "__main__":
    ...
    if API_KEY == "YOUR_API_KEY_HERE":
        print("WARNING: API Key is not set. Please set GOOGLE_API_KEY environment variable or edit the script locally.")
    else:
